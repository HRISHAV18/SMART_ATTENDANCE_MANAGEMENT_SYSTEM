...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "smartattendancesystem-76038.appspot.com"
})
            ...
            if modeType != 3:
                ...
                if counter <= 7:
                    ...
                    cv2.putText(imgBackground, str(id), (1006, 493),
                                cv2.FONT_HERSHEY_DUPLEX, 0.5, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(studentInfo['year']), (951, 625),
                                cv2.FONT_HERSHEY_DUPLEX, 0.6, (100, 100, 100), 1)
                    cv2.putText(imgBackground, str(studentInfo['starting_year']), (1069, 625),
                                cv2.FONT_HERSHEY_DUPLEX, 0.6, (100, 100, 100), 1)
                    ...
                    ph = studentInfo['phone']
                    print(ph)
                    
                    imgBackground[175:175 + 216, 909:909 + 216] = imgStudent
                
                if counter == 10:
                    cl.messages.create(body='Your attendance has been marked', from_='+15076903133', to=ph)
                counter += 1
